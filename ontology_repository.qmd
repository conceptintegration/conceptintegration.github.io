...
We are creating a public repository for ontologies in comparative law to collect ontologies in the field and provide a foundation for concept integration. Hosted here on GitHub, the repository will include ontologies from publishers and cataloguers, ontologies from individual authors of datasets, and relevant corpora. It will also include [interactive tools](https://conceptintegration.github.io/ontology_enrichment.html) we are developing to support the exploration of ontologies and corpora using our methodology.
