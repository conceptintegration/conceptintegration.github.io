...
**Description:** This documentation describes our rationale for refining topics in the Comparative Constitutions Project (CCP) ontology, initial revisions of the CCP ontology for use with NLP applications, results of those revisions, and ongoing revisions to improve topic matching and classification. View our [topic refinement process](https://github.com/conceptintegration/conceptintegration.github.io/blob/main/Ontology%20enrichment%20workflow.pdf).

**Ontology Enrichment Workflow**

**Description:** This documentation describes our workflow for combining automation and human expertise to systematically discover new topics and assess existing topics in an ontology. Topic discovery includes generating new candidate topics, selecting a candidate topic, designing and classifying the topic, assessing if the topic should be accepted or rejected or re-designed, applying a classification, and documenting the decision. Topic assessment includes selecting an existing topic, classifying the topic, assessing if the topic should be maintained or retired or re-designed, and documenting the decision. View our [ontology enrichment workflow](https://github.com/conceptintegration/conceptintegration.github.io/blob/main/Ontology%20enrichment%20workflow.pdf).

**Ontology Enrichment Methodology**

**Description:** This documentation describes our methodology for using the project’s ontology enrichment tool to add and revise topics in the CCP ontology. It defines how to select the search parameters, search the CCP ontology to compare a candidate topic to existing CCP topics, search national constitutions to view constitution sections that match the candidate topic, review results and revise the topic formulation to capture appropriate constitutional content, and document these decisions. View our [ontology enrichment methodology](https://github.com/conceptintegration/conceptintegration.github.io/blob/main/Ontology%20enrichment%20workflow.pdf).

**API Backend**

**Description:** This documentation describes the REST Application Programming Interface (API) that will serve as a backend for our public-facing interactive tools. It will be hosted on a University of Texas server and will execute computationally demanding tasks in our online tools. Tasks include representing user-provided texts as embeddings, computing semantic similarity, creating clusters of user-provided texts, and querying corpora for top matches. To achieve scalability and efficiency, the API uses the FastAPI toolkit and leverages k-nearest neighbors (k-NN) indexing via the nmslib library. In the current implementation, most tasks can be performed in a fraction of a second. View our [API backend documentation](https://github.com/conceptintegration/conceptintegration.github.io/blob/main/Ontology%20enrichment%20workflow.pdf).
