...
We have developed new interactive tools we are using in our work and preparing for public release in the next year. Thesse include the following tools related to ontology and corpus comparison.
