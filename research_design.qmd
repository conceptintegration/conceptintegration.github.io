...
Our methods translate to a series of research products we use in our own work but also intend to be useful to other researchers working in the legal domain. These include: (1) an [expanded CCP ontology](https://conceptintegration.github.io/ontology_enrichment.html), optimized for use with NLP tools and expanded to provide broader topic coverage, (2) comprehensive [constitutional analysis](https://conceptintegration.github.io/constitutional_analysis.html) of topics raised in national constitutions worldwide, (3) new methods for [consultation analysis](https://conceptintegration.github.io/consultation_analysis.html) to discover and trace ideas raised in public input during consultations on constitutional issues, (4) new methods for systematic [court ruling analysis](https://conceptintegration.github.io/court_analysis.html), revealing which constitutional ideas gain traction and how they evolve after a constitution’s adoption, (5) a public [ontology repository](https://conceptintegration.github.io/ontology_repository.html) where scholars can share, explore, and integrate concepts across the field of comparative law, and (6) [interactive tools](https://conceptintegration.github.io/ontology_enrichment.html) to explore ontologies and corpora using our methodology.
