...
Our methods translate to a series of research products we use in our own work but also intend to be useful to other researchers working in the legal domain. These include: (1) an [expanded CCP ontology](https://conceptintegration.github.io/ontology_enrichment.html), optimized for use with NLP tools and expanded to provide broader topic coverage, (2) a [comprehensive inventory of constitutional topics](https://conceptintegration.github.io/constitutional_analysis.html) in national constitutions worldwide, (3) new methods for discovering and tracing ideas raised in public comments during [constitutional consultations](https://conceptintegration.github.io/consultation_analysis.html), (4) a systematic analysis of constitutional ideas raised in national [court rulings](https://conceptintegration.github.io/court_analysis.html) worldwide, revealing which constitutional ideas gain traction and how they evolve after the constitution’s adoption, (5) a public [repository for ontologies](https://conceptintegration.github.io/ontology_repository.html) in comparative law where scholars can share, explore, and integrate concepts across the field, and (6) [interactive tools](https://conceptintegration.github.io/ontology_enrichment.html) to explore ontologies and corpora using our methodology.
